...
import { Shield, Share2, Award, User, LogOut, MessageSquare } from 'lucide-react';
...
const Navbar = () => {
  ...
  const linkClass = (path) => {
    ...
    return `flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-300 text-sm font-medium ${
      isActive
